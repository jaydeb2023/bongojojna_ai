...
export default function SearchPage() {
  ...
  useEffect(() => {
    fetchSchemes().then(data => { setSchemes(data); setLoading(false); });
  }, []);
    ...
    <div className="pb-24 min-h-screen">
      ...
      <div className="max-w-md mx-auto px-4">
        ...
        {loading ? (
          ...
          <>
            <p className="text-xs text-gray-400 mb-4">{filtered.length}টি স্কিম পাওয়া গেছে</p>
            {filtered.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <button onClick={() => { setQuery(''); setActiveCategory('all'); }} className="mt-3 text-saffron text-sm font-medium">সব দেখুন</button>
              </div>
            )}
          </>
        )}
